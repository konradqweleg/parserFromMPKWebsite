...
public class LineNameParser {
  ...
  public  Optional<LineData> createLineDataFromElement(Element elem, LineStatus status){
    ...
    public  ArrayList<LineData> parseLineNumberFromPage() throws IOException {
        ArrayList<LineData> lineNumber=new ArrayList<>();
        Document mainPage=DiskWebPageAccess.getMainPageDocument();
    ...
    public static void main(String[]args) throws IOException {
        ...
        for (LineData a:x.parseLineNumberFromPage()) {
