...
import org.example.lineNumbersParser.DiskWebPageAccess;
...
import org.example.lineNumbersParser.LineNameParser;
...
public class LineNameParserTest {
    ...
    public void parseLineNumberFromPage_exceptResultCorrectDataLines() throws IOException {
       ArrayList<LineData> lineData=  lineNameParser.parseLineNumberFromPage( DiskWebPageAccess.getMainPageDocument());
